...
class GetCountryMovieUsecase implements UseCase <Either<String, List<CountryMovieEntity>>, dynamic>{
  @override
  Future<Either<String, List<CountryMovieEntity>>> call({params}) async {
    return await sl<MovieRepository> ().getCountryMovie();
  }

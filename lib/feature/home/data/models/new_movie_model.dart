...
class NewMovieModel {
  ...
  factory NewMovieModel.fromJson(String source) => NewMovieModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
class ItemModel {
  ...
  factory ItemModel.fromMap(Map<String, dynamic> map) {
    return ItemModel(
      ...
      episode_current: map['episode_current'] != null ? map['episode_current'] as String : null,
      quality: map['quality'] != null ? map['quality'] as String : null,
      lang: map['lang'] != null ? map['lang'] as String : null,
      year: map['year'] as int,
      category: map['category'] != null ? List<CategoryModel>.from((map['category'] as List<dynamic>).map<CategoryModel?>((x) => CategoryModel.fromMap(x as Map<String,dynamic>),),) : null,
      country: map['country'] != null ? List<CountryModel>.from((map['country'] as List<dynamic>).map<CountryModel?>((x) => CountryModel.fromMap(x as Map<String,dynamic>),),) : null,
    );
  }
...
class TmDbModel {
  ...
  factory TmDbModel.fromJson(String source) => TmDbModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
class ModifiedModel {
  ...
  factory ModifiedModel.fromJson(String source) => ModifiedModel.fromMap(json.decode(source) as Map<String, dynamic>);
}

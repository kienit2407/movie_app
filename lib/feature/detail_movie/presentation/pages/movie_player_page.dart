...
class _MoviePlayerPageState extends State<MoviePlayerPage>
  ...
  Future<void> _disposeAndInitializePlayer(
    ...
    _lastPosition = null; // luôn clear để không dính sang lần sau
    setState(() {});
  }
  ...
  void _submitEpisode() {
    ...
    if (episodeIndex == -1) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Không tìm thấy tập $epNum trên server hiện tại.'),
        ),
      );
      return;
    }
  ...
  Widget _buildVideoAreaWithoutSeekbar() {
    ...
    return GestureDetector(
      ...
      onVerticalDragStart: (_) => _miniDragDy = 0,
      ...
      child: ClipRect(
        child: Stack(
          ...
          children: [
            ...
            // // Lớp 3: Gradient PHỤ - Phủ hai bên trái/phải để xóa mép video
            // Positioned.fill(
            //   child: DecoratedBox(
            //     decoration: BoxDecoration(
            //       gradient: LinearGradient(
            ...
            //         colors: [
            //           AppColor.bgApp.withValues(alpha: 0.7), // Trái đậm
            //           AppColor.bgApp.withValues(
            //             alpha: 0.0,
            //           ), // Giữa trong suốt để thấy video
            //           AppColor.bgApp.withValues(alpha: 0.7), // Phải đậm
            //         ],
  ...
  // Panel header/handle: kéo lên/xuống để resize video
  Widget _buildPanelHeaderHandle() {
    return GestureDetector(
      ...
      onVerticalDragUpdate: (details) {
        ...
        // kéo panel lên (delta âm) => video cao lên
        final newHeight = _initialHeight - delta;

        setState(() {
          _videoHeight = newHeight.clamp(_minVideoHeight, _maxVideoHeight);
        });
      },
      onVerticalDragEnd: (_) {
        setState(() => _isDragging = false);

        final mid = (_minVideoHeight + _maxVideoHeight) / 2;
        final isNearMax = _videoHeight >= _maxVideoHeight - 80;
        setState(() {
          if (isNearMax) {
            _videoHeight = _maxVideoHeight;
            _isExpanded = true;
          } else if (_videoHeight > mid) {
            _videoHeight = _maxVideoHeight;
            _isExpanded = true;
          } else {
            _videoHeight = _minVideoHeight;
                          ...
                          children: [
                            ...
                            AnimatedContainer(
                              ...
                              child: Column(
                                ...
                                children: [
                                  // Handle kéo để resize video
                                  _buildPanelHeaderHandle(),
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        // PHẦN BÊN TRÁI: Tên phim (Bọc Expanded để tránh lỗi tràn ngang)
                                        Expanded(
                                          child: Container(
                                        ...
                                        // PHẦN BÊN PHẢI: Chữ "Mở xem thêm"
                                        InkWell(
                                          borderRadius: BorderRadius.circular(
                                            10,
                                          ),
                                          onTap: () {
                                            _isExpandInfor = !_isExpandInfor;
                                            setState(() {});
                                          },
                                          child: Row(
                                            spacing: 2,
                                            children: [
                                              ...
                                              AnimatedRotation(
                                                ...
                                                // Xoay 0.5 vòng (180 độ) nếu mở, 0 vòng nếu đóng
                                                turns: _isExpandInfor
                                                    ? 0.5
                                                    : 0.0,
                                                child: Icon(
                                                  Iconsax
                                                      .arrow_down_1_copy, // Chỉ cần dùng 1 icon duy nhất
                                                  size: 14,
                                                  color: Colors.white
                                                      .withValues(alpha: 0.6),
                                                ),
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      icon: const Icon(Iconsax.arrow_right_3_copy, color: Colors.white, size: 16),
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(10),
              onTap: () => _playEpisode(index, widget.episodes[index]),
              child: Ink(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10),
                ),
                ...
                ClipRRect(
                  ...
                  child: BackdropFilter(
                    ...
                    child: Container(
                      ...
                      // height: 180,
                      decoration: BoxDecoration(
                        color: AppColor.bgApp.withValues(alpha: .1),
                        border: Border(
                          top: BorderSide(
                  ...
                  child: ClipRRect(
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        // height: 180,
                        decoration: BoxDecoration(
                          color: AppColor.bgApp.withValues(alpha: .3),
                          border: Border(
                            top: BorderSide(
                              color: Colors.grey.withValues(alpha: .5),
                            ),

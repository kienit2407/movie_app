...
class _AllMoviePageState extends State<AllMoviePage> {
  ...
  // Key to measure large title position
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          _buildContent(gradientColor),
        ],
      ),
    );
  }

  Widget _buildContent(LinearGradient gradientColor) {
              ...
              flexibleSpace: ClipRect(
                child: BackdropFilter(
                  filter: ImageFilter.blur(
                    sigmaX: _showSmallTitle ? 15.0 : 0.0,
                    sigmaY: _showSmallTitle ? 15.0 : 0.0,
                  ),
                  child: AnimatedContainer(
                    duration: const Duration(milliseconds: 200),
                    decoration: BoxDecoration(
                      gradient: _showSmallTitle
                          ? LinearGradient(
                              begin: gradientColor.begin,
